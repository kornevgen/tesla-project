...
технологическая цепочка построения теста с использованием продвинутых техник

комментарии по шагам:
* модель состояния
* язык описания инструкций обращения к памяти (это тоже результат!)
* метод построения ограничений для последовательности обращений в таблицу
* метод записи стратегии вытеснения
