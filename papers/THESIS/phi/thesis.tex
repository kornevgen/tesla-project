...
%% 16) еще раз прослушать то, что сказал Р.Л. в записи от 7 октября
%%
%% 5) заменить "на ветвях бин.дерева" на "в терминах бин.дерева" ? (а как в автореферате?)
%% 10) посмотреть словосочетания "в памят", "в табл" (где-то надо заменить на "к таблице")
%% 11) "варианты инструкции" заменить на "варианты исполнения инструкции"
%%
