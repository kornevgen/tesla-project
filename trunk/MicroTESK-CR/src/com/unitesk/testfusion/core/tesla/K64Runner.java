...
public class K64Runner
{
	...
	public K64Runner( String load_path, String jrubyHome, String instructions_path )
	{
		for( String path : Arrays.asList(load_path, jrubyHome, instructions_path + File.separator, jrubyHome + "\\lib") )
		{
		...
		this.instructions_path = instructions_path + File.separator;
...
//			System.out.println();
			...
			RubyHash hash, KMD64Context context)
	{
		for( String name : namesForOperands.keySet() )
		{
			...
			if ( value == null )
			{
				throw new IllegalStateException("couldn't find value for '" + name + "_X'");
			}
