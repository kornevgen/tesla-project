...
\pagestyle{plain} \setstretch{1.2} %1.3 = \onehalfspacing,  1.6 = \doublespacing
...
%% 22) опечатки в картинках! (рис.2.11 - "одноЙ", "обращения из тестового шаблона в таблицу")
%%          рис.2.16: "последовательность обращений к региону таблицы", "тестовый шаблон" -> "последовательность обращений из тестового шаблона"
%%
%% 20) прокомментировать спецификацию на RSL (а то без пояснений она непонятная)
%% 23) прокомментировать лучше, что изображено на рисунках 3.5 и 3.6
%% 24) прокомментировать рисунки про Genesys-Pro
%%
